...
-(void)addSubtiledSquad:(CGPoint)pos ul:(int)ul ur:(int)ur bl:(int)bl br:(int)br {
	...
	/*
	if(ul == ur) {
		[self createSubSquad:CGRectMake(x, y, 1.0f, 0.5f) coords:CGRectMake(0.0f, 0.0f, 1.0f, 0.5f) offset:ul];
	} else if(ul == bl) {
		[self createSubSquad:CGRectMake(x, y, 0.5f, 1.0f) coords:CGRectMake(0.0f, 0.0f, 0.5f, 1.0f) offset:ul];
	}*/
}
